      ...
      <main className="pb-20">
        ...
        {status === GenerationStatus.IDLE && (
          <div className="max-w-2xl mx-auto mt-16 text-center px-4 opacity-50 pointer-events-none select-none">
             ...
             <p className="text-zinc-600 text-sm">Vector Graphic will appear here</p>
          </div>
        )}
      </main>
      
      {/* Fixed Bottom Footer */}
      <footer className="fixed bottom-0 left-0 right-0 bg-zinc-900/80 backdrop-blur border-t border-white/10 py-3">
        <div className="text-center">
          <a 
            href="https://gemini-svg.vercel.app" 
            target="_blank" 
            rel="noopener noreferrer"
            className="text-zinc-400 hover:text-white transition-colors text-sm font-medium flex items-center justify-center gap-2"
          >
            <img src="/icons/apple-touch-icon.png" alt="Gemini SVG" className="w-5 h-5" />
            Gemini SVG
          </a>
        </div>
      </footer>
